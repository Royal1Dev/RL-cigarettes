...
AddEventHandler('cigarettes:client:UseCigarette', function()
    ...
    if IsPedInAnyVehicle(PlayerPedId(), false) then
        ...
        --TriggerEvent('scully_emotemenu:playByCommand', 'smoke3')     Choose your system emote
        exports["dpemotes"]:EmoteCommandStart("smoke", 3)

    else
        --TriggerEvent('animations:client:EmoteCommandStart', {"smoke"})
        --TriggerEvent('scully_emotemenu:playByCommand', 'smoke')       Choose your system emote
        exports["dpemotes"]:EmoteCommandStart("smoke", 2)
    end
